...
if(isset($_SESSION['logged_in']) && $_SESSION['logged_in'] === true) {
    ...
    <head>
        ...
        <script type="text/javascript" src="admin/admin_main.js"></script>
    ...
    <div id="page-wrapper">
        <div id="page">
            <header>
                ...
                <a class="active" href="admin_main.php">Main</a>
                    ...
                    <div id="form_wrapper">
                        ...
                        foreach($content_types as $item) {
                            ...
                            <form id="<?php echo 'form_' . $item["name"] ?>" class="content_type_form">
                                ...
                                <div class="form_item">
                                    <label>Magnet</label>
                                    <input data-type="text" type="text" name="magnet" >
                                </div>
                                <?php foreach ($item["fields"] as $field) {
                                    if ($field["datatype"] == "file") {
                                        ...
                                        for ($i = 0; $i < count($options); $i++) {
                                            ?>
                                            <label><?php echo $options[$i]; ?></label>
                                            <input data-type="<?php echo $field["datatype"]; ?>"
                                                   data-fieldId="<?php echo $field["id"]; ?>"
                                                   type="<?php echo $field["datatype"]; ?>"
                                                   name="<?php echo $field["name"]; ?>"
                                                   value="<?php echo $options[$i]; ?>" <?php if ($i == 0) echo "checked" ?>>
                                            <?php
                                        }
                                            ?>
                                        </div>
                                ...
                                foreach($item["fields"] as $field) {
                                    ...
                                    <div class="form_item">
                                        ...
                                        <?php } else if ($field["datatype"] != "file" && $field["datatype"] != "radio") { ?>
                                            <label><?php echo $field["name"]; ?></label>
